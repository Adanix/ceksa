...
<head>
    ...
    <title>Login - Pages | Sistem Pakar Stunting</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body mt-2 text-center">
                        ...
                        <form id="formAuthentication" class="mb-3" action="ceklogin" method="POST">
                            @csrf
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Masukan email" autofocus required />
