...
<div class="card">
   <div class="d-flex justify-content-between align-items-center">
      ...
      <button type="button" class="btn btn-info waves-effect waves-light me-3 mt-3" data-bs-toggle="modal" data-bs-target="#fullscreenModal">
         <span class="tf-icons mdi mdi-help-box-multiple-outline me-1"></span>
   ...
   <div class="card-body">
      <form id="formValidationExamples" action="{{ route('diagnosa.store') }}" method="post" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
         @csrf
         @method('POST')
