...
<head>
    ...
    <title>Dashboard - Responden | {{ $title }}</title>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/responden/dashboard" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-semibold ms-2">Pengguna</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ $title === 'Home' ? 'active' : '' }}">
                        <a href="/responden/dashboard" class="menu-link">
                            <i class="menu-icon tf-icons mdi mdi-home-outline"></i>
                            <div data-i18n="Dashboards">Dashboard</div>
                        </a>
                    </li>
                    <li class="menu-item {{ $title === 'Diagnosa Stunting' ? 'active' : '' }}">
                        <a href="/responden/diagnosa" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a class="menu-link" onclick="event.preventDefault();
                            document.getElementById('logout-form-responden').submit();">
                            <i class="menu-icon tf-icons mdi mdi-logout"></i>
                            <div data-i18n="Academy">Keluar</div>
                            <form id="logout-form-responden" action="/responden/logout" method="POST">
                                @csrf
                            </form>
                        </a>
                    </li>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/responden/profil">
                        ...
                        <div class="container-xxl">
                            <div class="footer-container d-flex align-items-center justify-content-between py-3 flex-md-row flex-column">
                                <div class="text-body mb-2 mb-md-0">
                                    ...
                                    </script>, with <span class="text-danger"><i class="tf-icons mdi mdi-heart"></i></span> by
