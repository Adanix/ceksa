...
<div class="">
    ...
    <div class="modal fade" id="backDropModalUlti" data-bs-backdrop="static" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <form class="modal-content" action="{{ route('rule.store') }}" method="post">
                @csrf
                        ...
                        <div class="col mb-4 mt-2">
                            <div class="form-floating form-floating-outline">
                                <select name="nama_gejala" id="defaultSelect" class="form-select" required>
                                    ...
                                    @foreach ($gej as $ge)
                                    <!-- //! ini salah harusnya vaue kode gejala-->
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="backDropModal{{ $gejalaItem->id }}" data-bs-backdrop="static" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <form class="modal-content" action="{{ route('rule.update', $gejalaItem->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="backDropModalTitle">Edit Rule</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col mb-4 mt-2">
                                                <div class="form-floating form-floating-outline">
                                                    <select name="nama_gejala" id="defaultSelect" class="form-select" required>
                                                        <option value="{{ $gejalaItem->nama_gejala }}">
                                                            {{ $gejalaItem->nama_gejala }}
                                                        </option>
                                                        @foreach ($gej as $ge)
                                                        <option value="{{ $ge->nama_gejala }}">
                                                            {{ $ge->nama_gejala }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                        ...
                        <div class="modal fade" id="modalHapus{{ $gejalaItem->id }}" data-bs-backdrop="static" tabindex="-1" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <form action="{{ route('rule.destroy', $gejalaItem->id) }}" method="post" class="modal-content">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="backDropModalTitle">Hapus Rule</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
